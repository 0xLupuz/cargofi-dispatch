                ...
                {notifs.map(n => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-start gap-3 px-4 py-3 cursor-pointer transition-colors hover:bg-gray-800/50 ${!n.read ? 'bg-gray-800/30' : ''}`}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button onClick={e => dismiss(n.id, e)} className="text-gray-600 hover:text-gray-400 flex-shrink-0 mt-0.5">
                            <X className="w-3 h-3" />
                          </button>
                        </div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          {n.link && <ExternalLink className="w-2.5 h-2.5 text-gray-600" />}
                          {!n.read && <span className="w-1.5 h-1.5 rounded-full bg-orange-400 ml-auto" />}
                        </div>
                      </div>
                    </div>
                  )
