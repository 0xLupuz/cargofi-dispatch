  ...
  return (
    ...
    >
      ...
      <div className="mt-12 space-y-1">
        ...
        <p className="text-xs uppercase text-[#484f58] mt-1">{f.opsName}</p>
      </div>
    </div>
  )
}
          ...
          <div className="flex-1 px-4 py-4 space-y-3">
            ...
            <label className="flex flex-col gap-1">
              <span className="text-[10px] font-semibold uppercase tracking-wider text-gray-500">
                Pre-fill desde Load {loadFetching && <span className="text-[#3ab690]">cargando…</span>}
              </span>
              <select
                value={selectedLoad}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {form.drivers.map((drv, i) => (
                <div key={i} className="flex gap-1.5 items-center">
                  <input
                    ...
                    className="flex-1 bg-[#161b22] border border-[#30363d] rounded-md px-2.5 py-1.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#3ab690]"
                  />
              ...
              <button
                onClick={addDriver}
                className="flex items-center gap-1 text-xs text-gray-500 hover:text-[#3ab690] transition-colors mt-0.5"
              >
